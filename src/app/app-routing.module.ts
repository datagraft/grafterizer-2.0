...
const appRoutes: Routes = [
  ...
  { path: ':datagraftpath/oauth/begin', component: TabularTransformationComponent },
  ...
  { path: 'transformations/new/tabular-transformation', redirectTo: ':datagraftpath/oauth/begin', pathMatch: 'full' },
  // { path: '**', redirectTo: ':publisher/transformations/:transformationId', pathMatch: 'full' }
];
